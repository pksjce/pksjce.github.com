...
So, I came across a scaffold generator for Ember called (surprise!) generator-ember. --Its just the convention for generators--. 
...
Now I went to the yeoman generator tutorial at 
...
So, I picked . This was more of a gruntfile change than anything to do with yeoman. All I had to do was modify the grunt task of usemin to pick ember.prod.js while creating the concat subtask and replace the template in the app folder.
